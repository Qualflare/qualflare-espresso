...
First release candidate. Cut before 0.1.0 deliberately: Maven Central is immutable, and the
Maestro reporter's rc caught a broken `go install` that thirteen task reviews had missed.
